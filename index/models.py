...
class Goods(models.Model):
    ...
    imagea=models.ImageField(verbose_name='产品图片1',upload_to='img/%Y/%d')
    imageb=models.ImageField(verbose_name='产品图片2',upload_to='img/%Y/%d')
    imagec=models.ImageField(verbose_name='产品图片3',upload_to='img/%Y/%d')
    imaged=models.ImageField(verbose_name='产品图片4',upload_to='img/%Y/%d')
    imagee=models.ImageField(verbose_name='产品图片5',upload_to='img/%Y/%d')
    imagef=models.ImageField(verbose_name='产品图片6',upload_to='img/%Y/%d')
...
class Fengjing(models.Model):
    ...
    imagea=models.ImageField(verbose_name='风景图片1',upload_to='img/%Y/%d')
    imageb=models.ImageField(verbose_name='风景图片2',upload_to='img/%Y/%d')
    imagec=models.ImageField(verbose_name='风景图片3',upload_to='img/%Y/%d')
    imaged=models.ImageField(verbose_name='风景图片4',upload_to='img/%Y/%d')
    imagee=models.ImageField(verbose_name='风景图片5',upload_to='img/%Y/%d')
    imagef=models.ImageField(verbose_name='风景图片6',upload_to='img/%Y/%d')
...
class Tuandui(models.Model):
    ...
    image=models.ImageField(verbose_name='头像',upload_to='image/%Y/%d')
...
class Rongyu(models.Model):
    ...
    image = models.ImageField(verbose_name='荣誉图片', upload_to='image/%Y/%d')
...
class Lunbo(models.Model):
    ...
    image=models.ImageField(verbose_name='轮播图',upload_to='ima/%Y/%d')
